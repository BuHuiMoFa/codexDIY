  ...
  const handleAddFromPreset = useCallback((preset: PresetProvider) => {
    ...
    addProvider({
      ...
      modelMappings: [
        {
          tier: 'opus',
          providerModel: preset.defaultModels?.opus || preset.defaultModel || DEFAULT_PROVIDER_MODELS.opus,
        },
        {
          tier: 'sonnet',
          providerModel: preset.defaultModels?.sonnet || preset.defaultModel || DEFAULT_PROVIDER_MODELS.sonnet,
        },
        {
          tier: 'haiku',
          providerModel: preset.defaultModels?.haiku || preset.defaultModel || DEFAULT_PROVIDER_MODELS.haiku,
        },
      ],
