...
const messages: Record<Locale, Record<string, string>> = {
  zh: {
    ...
    'sidebar.usageList': '用量列表',
    'sidebar.currentSession': '当前会话',
    'sidebar.taskPanel': '任务面板',
    'sidebar.taskTurn': '第',
    'sidebar.taskLive': '实时过程',
    'sidebar.taskChanges': '本轮变更',
    'sidebar.taskProcess': '过程',
    'sidebar.taskLast': '最近状态',
    'sidebar.taskReady': '等待新的流式事件',
    'sidebar.taskOpenFiles': '查看文件',
    ...
    'chat.latest': '最新',
    'chat.changedFiles': '本轮改动',
    'chat.changeCreated': '新建',
    'chat.changeEdited': '修改',
    'chat.changeTerminal': '终端',
    'chat.welcome': `欢迎使用 ${APP_NAME}`,
    'chat.welcomeWithProject': '开始与 AI 协作，CLI 会话在后台无缝运行。',
    'chat.welcomeNoProject': '选择一个项目文件夹以开始。',

    // InputBar
    'input.working': 'AI 正在工作...',
    'input.followUp': '追加消息...',
    'input.placeholder': '给 AI 发消息...',
    ...
    'preview.autoRefresh': '预览已根据文件变更自动刷新',
    ...
    'files.preview': '预览',
    'files.review': '审阅',
    'files.reviewHint': '已提取 Word / Excel 正文，可在软件中直接审阅',
    'files.source': '源码',
    ...
    'chat.toolStatus.editFile': '正在编辑文件',
    'chat.toolStatus.runCommand': '正在执行命令',
    'chat.toolStatus.inspectProject': '正在检查项目',
    'chat.toolStatus.runSubtask': '正在运行子任务',
    'chat.toolStatus.writingReply': '正在生成回复',
    ...
    'msg.planReview': '审查 AI 的计划',
    'msg.planApprove': '批准计划并开始执行',
    'msg.planModify': '告诉 AI 如何修改',
    ...
    'provider.opusModel': '主模型',
    'provider.sonnetModel': '快速模型',
    'provider.haikuModel': '备用模型',
  ...
  en: {
    ...
    'sidebar.usageList': 'Usage List',
    'sidebar.currentSession': 'Current Session',
    'sidebar.taskPanel': 'Task Panel',
    'sidebar.taskTurn': 'Turn',
    'sidebar.taskLive': 'Live Process',
    'sidebar.taskChanges': 'Current Changes',
    'sidebar.taskProcess': 'Process',
    'sidebar.taskLast': 'Latest status',
    'sidebar.taskReady': 'Waiting for stream events',
    'sidebar.taskOpenFiles': 'Open files',
    ...
    'chat.latest': 'Latest',
    'chat.changedFiles': 'Changed',
    'chat.changeCreated': 'Created',
    'chat.changeEdited': 'Edited',
    'chat.changeTerminal': 'Terminal',
    'chat.welcome': `Welcome to ${APP_NAME}`,
    'chat.welcomeWithProject': 'Start working with AI. Your CLI session runs seamlessly in the background.',
    'chat.welcomeNoProject': 'Select a project folder to get started.',

    // InputBar
    'input.working': 'AI is working...',
    ...
    'conv.deleteFailed': 'Failed to delete task',
    ...
    'preview.autoRefresh': 'Preview refreshed after file changes',
    ...
    'files.review': 'Review',
    'files.reviewHint': 'Extracted Word or Excel text is ready for in-app review.',
    'files.source': 'Source',
    ...
    'chat.toolStatus.editFile': 'Editing file',
    'chat.toolStatus.runCommand': 'Running command',
    'chat.toolStatus.inspectProject': 'Inspecting project',
    'chat.toolStatus.runSubtask': 'Running subtask',
    'chat.toolStatus.writingReply': 'Generating reply',
    // Cycling thinking words (typewriter animation)
    ...
    'msg.copied': 'Copied!',
    'msg.editMessage': 'Edit Again',
    'msg.editEditing': 'Editing',
    'msg.editResend': 'Resend',
    'msg.editLoaded': 'Loaded',
    ...
    'msg.planReview': 'Review the AI plan',
    'msg.planApprove': 'Approve plan and start coding',
    'msg.planModify': 'Tell the AI what to change',
    ...
    'provider.opusModel': 'Primary',
    'provider.sonnetModel': 'Fast',
    'provider.haikuModel': 'Fallback',
